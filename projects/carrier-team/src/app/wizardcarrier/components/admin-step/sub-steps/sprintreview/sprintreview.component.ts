...
export class SprintreviewComponent implements OnInit {
  sprints: any[] = [];
  EnableCustomToggle:boolean = false;
  
  SummarySprintData:boolean = false;
  IncludeOldSprintCheckbox:boolean = false;
  IncludeFutureSprintCheckbox:boolean = false;
  ...
  ngOnInit(): void {
    this.wizardBackendService.getLastSprints().subscribe({
      next: (data: any) => {
        ...
        const activeSprintIndex = allSprints.findIndex(
          (sprint) => sprint.state.toLowerCase() === 'active'
        );
    ...
    this.wizardBackendService.getJiraSprint(sprintId).subscribe({
      next: (data: any) => {
        ...
        data.issues.forEach((element: any) => {
          ...
          // Count by status
          OldticketSummary.jiraStatusCounts[status] =
            (OldticketSummary.jiraStatusCounts[status] || 0) + 1;
          ...
          // Count by carrier
          OldticketSummary.jiraCarrierCounts[carrier] =
            (OldticketSummary.jiraCarrierCounts[carrier] || 0) + 1;
  
          // Count by priority
          OldticketSummary.jiraPriorityCounts[priority] =
            (OldticketSummary.jiraPriorityCounts[priority] || 0) + 1;
        ...
        OldticketSummary.jiraReleasedTicketInProduction =
          OldticketSummary.jiraStatusCounts['Closed'] || 0;
    ...
    this.wizardBackendService.getJiraSprint(sprintId).subscribe({
      next: (data: any) => {
        ...
        data.issues.forEach((element: any) => {
          ...
          // Count by status
          FutureticketSummary.jiraStatusCounts[status] =
            (FutureticketSummary.jiraStatusCounts[status] || 0) + 1;
          ...
          // Count by carrier
          FutureticketSummary.jiraCarrierCounts[carrier] =
            (FutureticketSummary.jiraCarrierCounts[carrier] || 0) + 1;
        ...
        FutureticketSummary.jiraReleasedTicketInProduction =
          FutureticketSummary.jiraStatusCounts['Closed'] || 0;
    ...
    this.wizardBackendService.getJiraSprint(sprintId).subscribe({
      next: (data: any) => {
        ...
        data.issues.forEach((element: any) => {
          ...
          // Count by status
          ticketSummary.jiraStatusCounts[status] =
            (ticketSummary.jiraStatusCounts[status] || 0) + 1;
  
          // Count by type
          ticketSummary.jiraTypeCounts[issueObject.type] =
            (ticketSummary.jiraTypeCounts[issueObject.type] || 0) + 1;
  
          // Count by carrier
          ticketSummary.jiraCarrierCounts[carrier] =
            (ticketSummary.jiraCarrierCounts[carrier] || 0) + 1;
  
          // Count by priority
          ticketSummary.jiraPriorityCounts[priority] =
            (ticketSummary.jiraPriorityCounts[priority] || 0) + 1;
        ...
        ticketSummary.jiraReleasedTicketInProduction =
          ticketSummary.jiraStatusCounts['Closed'] || 0;
